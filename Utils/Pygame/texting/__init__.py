...
key_data: List[Tuple[int, Tuple[int, callable]]] = [(0x08, (0, delete_letter)), (0x08, (64, delete_word))]
            ...
            if mods:
                if not mods[0]:  # if you picked it would work without mods
                    ...
                    for mod in mods:
                        ...
                        break  # shit code like this may break my bones but words could never hurt me
                continue
            else:
                break
    else:
